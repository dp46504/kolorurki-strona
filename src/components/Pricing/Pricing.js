  ...
  return (
    <>
      <Container>
        ...
        <SubTitle>
          Karnet upoważnia do wstępu na wszystkie prowadzone zajęcia grupowe,
          bez limitu wejść. Karnet ważny jest przez miesiąc. Nie ogranicza Cię
          nic, poza ilością godzin w dobie i Twoim zapałem.
        </SubTitle>
      </Container>
    </>
  );
